...
print "HI. Today we'll review of octal math.\r\n"
...
print "Now it\'s your turn. Write the place values for base 2 or the octal system. Just go 5 places this time.\r"
...
def conversion():
  ...
  answer = raw_input("Convert " + str(decimal_number) + " to octal: ")
  print("0" + answer)
  print(oct(decimal_number))
  while "0" + answer != str(oct(decimal_number)):
